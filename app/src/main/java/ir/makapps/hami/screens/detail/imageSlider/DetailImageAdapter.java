...
public class DetailImageAdapter extends PagerAdapter {
    ...
    public DetailImageAdapter(Context context, List<String> imageModelList) {
...
//        imageLoader.get(utils.getSliderImageUrl(), ImageLoader.getImageListener(imageView, R.mipmap.ic_launcher, android.R.drawable.ic_dialog_alert));
        ...
        Picasso.get().load(imageModelList.get(position)).placeholder(R.drawable.banner).into(imageView);
